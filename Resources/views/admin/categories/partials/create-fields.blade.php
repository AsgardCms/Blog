<div class="box-body">
    <div class='form-group{{ $errors->has("name[{$lang}]") ? ' has-error' : '' }}'>
        ...
        {!! Form::text("name[{$lang}]", Input::old("name[{$lang}]"), ['class' => 'form-control slugify', 'placeholder' => trans('blog::category.form.name')]) !!}
    ...
    <div class='form-group{{ $errors->has("slug[{$lang}]") ? ' has-error' : '' }}'>
       ...
       {!! Form::text("slug[{$lang}]", Input::old("slug[{$lang}]"), ['class' => 'form-control slug', 'placeholder' => trans('blog::category.form.slug')]) !!}
