<div class="box-body">
    <div class='form-group{{ $errors->has("name[{$lang}]") ? ' has-error' : '' }}'>
        ...
        {!! Form::text("name[{$lang}]", Input::old("name[{$lang}]", $category->translate($lang)->name), ['class' => 'form-control', 'placeholder' => trans('blog::category.form.name')]) !!}
    ...
    <div class='form-group{{ $errors->has("slug[{$lang}]") ? ' has-error' : '' }}'>
           ...
           {!! Form::text("slug[{$lang}]", Input::old("slug[{$lang}]", $category->translate($lang)->slug), ['class' => 'form-control', 'placeholder' => trans('blog::category.form.slug')]) !!}
