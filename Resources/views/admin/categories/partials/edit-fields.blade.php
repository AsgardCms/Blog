<div class="box-body">
    <div class='form-group{{ $errors->has("{$lang}[name]") ? ' has-error' : '' }}'>
        ...
        {!! Form::text("{$lang}[name]", Input::old("{$lang}[name]", $old), ['class' => 'form-control slugify', 'placeholder' => trans('blog::category.form.name')]) !!}
    ...
    <div class='form-group{{ $errors->has("{$lang}[slug]") ? ' has-error' : '' }}'>
           ...
           {!! Form::text("{$lang}[slug]", Input::old("{$lang}[slug]", $old), ['class' => 'form-control slug', 'placeholder' => trans('blog::category.form.slug')]) !!}
