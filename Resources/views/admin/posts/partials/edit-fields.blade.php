<div class="box-body">
    <div class='form-group{{ $errors->has("title[{$lang}]") ? ' has-error' : '' }}'>
        ...
        {!! Form::text("title[{$lang}]", Input::old("title[{$lang}]", $post->translate($lang)->title), ['class' => 'form-control slugify', 'placeholder' => trans('blog::post.form.title')]) !!}
    ...
    <div class='form-group{{ $errors->has("slug[{$lang}]") ? ' has-error' : '' }}'>
       ...
       {!! Form::text("slug[{$lang}]", Input::old("slug[{$lang}]", $post->translate($lang)->slug), ['class' => 'form-control slug', 'placeholder' => trans('blog::post.form.slug')]) !!}
